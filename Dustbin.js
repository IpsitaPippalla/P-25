...
class Dustbin {
    ...
    constructor(x,y) {
        ...
        part1 = Bodies.rectangle(x, y+10, 200, 100, options);
        part1.width = 200;
        part1.height = 200;
    
        part2 = Bodies.rectangle(x-20, y-30, 20,150, options);
        part2.width = 20;
        part2.height = 100;

        part3 = Bodies.rectangle(x+60, y-30, 20, 150, options);
        part3.width = 20;
        part3.height = 100;
    ...
    display(){
        ...
        rectMode(CENTER);
        fill("white");
        image(this.image,-85,-110, part1.width, part1.height);
